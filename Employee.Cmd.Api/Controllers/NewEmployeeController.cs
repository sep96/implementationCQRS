...
namespace Employee.Cmd.Api.Controllers
{
    ...
    {
        private readonly ILogger<NewEmployeeController> _logger;
        private readonly ICommandDispatcher _commandDispatcher;

        public NewEmployeeController(ILogger<NewEmployeeController> logger, ICommandDispatcher commandDispatcher)
        {
            _logger = logger;
